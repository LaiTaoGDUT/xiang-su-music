<template>
  <div class="player">
    ...
    <div class="bar3">
      <z-icon :type="mutedIcon" @click.native="onMuted" :title="mutedTitle" style="cursor: pointer;" />
    ...
    <div class="bar4">
      ...
      <a @click="showMusicView" title="沉浸模式">
        <img src="./../../assets/images/inView.png" style="vertical-align: sub;" />
      </a>
      <a @click="toggleCurrentLyric"  class="lrc" :title="showDesktoplyric ? '桌面歌词：开' : '桌面歌词：关'">
        <img src="./../../assets/images/lyric.png"  v-show='!showDesktoplyric' style="vertical-align: sub;" />
        <img src="./../../assets/images/lyric2.png" v-show='showDesktoplyric'  style="vertical-align: sub;" class="background-active" />
      </a>
      <a @click="toggleTransShow"  class="tran" :title="show_trans ? '翻译：开' : '翻译：关'">
        <img src="./../../assets/images/trans.png"  v-show='!show_trans' style="vertical-align: sub;" />
        <img src="./../../assets/images/trans2.png" v-show='show_trans' style="vertical-align: sub;" class="background-active" />
      </a>
      <a @click="toggleDesktopView"  class="view" :title="showDesktopView ? '桌面动效：开' : '桌面动效：关'">
        <img src="./../../assets/images/view.png"  v-show='!showDesktopView' style="vertical-align: sub;" />
        <img src="./../../assets/images/view2.png" v-show='showDesktopView' style="vertical-align: sub;" class="background-active" />
      </a>
      <a @click="showDrawer"  class="count-wrapper" title="播放列表">
        <img src="./../../assets/images/list.png" style="vertical-align: sub;" />
      </a>
    </div>
