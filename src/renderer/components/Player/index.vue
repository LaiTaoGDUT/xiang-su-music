    ...
    <div class="player" ref="player" v-show="fullscreen">
      <section class="main">
        ...
        <div class="main-top">
          ...
          <div class="right" v-if="Object.keys(current_song).length">
            ...
            <div class="lyric">
              ...
              <lyric-list class="default" ref="lyrics" :showTime='showTime' />
            </div>
          </div>
        </div>
        <div class="main-bottom">
          ...
          <div class="right">
            <div class="col" v-if="!(current_song.folder && !current_song.matched) && simiPlaylists.length">
            ...
            <div class="col" v-if="!(current_song.folder && !current_song.matched) && simiSongs.length">
            ...
            <div class="col" v-if="!(current_song.folder && !current_song.matched) && users.length">
...
export default {
      ...
      if (newVal) {
        this.unWatcher_lyric = this.$watch('current_lyric_line', (newLine) => {
          ...
          if (lines && lines[newLine]) {
            let top = lines[newLine].offsetTop > 0 ? Number(lines[newLine].offsetTop - LYRIC_LINE_HEIGHT * 4) : 0
            this.$refs.lyrics.scrollTo(top, 'smooth')
          }
        })
        let img = new Image()
  ...
  methods: {
    ...
    _getSongUsers (id) {
      if (this.current_song.folder && !this.current_song.matched) {
        return
      }
